...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    columnSortOrder: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    newsletterSent: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    newsletterSentAt: Schema.Attribute.DateTime;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    homeSectionTitle: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiMediaKitLeadMediaKitLead
  extends Struct.CollectionTypeSchema {
  collectionName: 'media_kit_leads';
  info: {
    displayName: 'media-kit-lead';
    pluralName: 'media-kit-leads';
    singularName: 'media-kit-lead';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    downloadedAt: Schema.Attribute.DateTime;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
...
export interface ApiWriteForUsSubmissionWriteForUsSubmission
  extends Struct.CollectionTypeSchema {
  collectionName: 'write_for_us_submissions';
  info: {
    displayName: 'write-for-us-submission';
    pluralName: 'write-for-us-submissions';
    singularName: 'write-for-us-submission';
  };
  options: {
    draftAndPublish: true;
  };
